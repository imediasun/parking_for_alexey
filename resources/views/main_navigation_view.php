...
<nav style="position:relative;">
    ...
    <div class="container" style="position:relative;">
        <div class="nav-inner" style="position:relative;">
            ...
            <ul id="nav" class="nav_block1 hidden-xs">
                <li id="nav-home" class="level0 parent drop-menu active"><a ><span>Главная</span> </a> </li>
                <?
                class Recursion
                {
                    public $level;
                    ...
                    public function view_cat($arr, $parent_id = 0, $level ) {
                        ...
                        if($parent_id !== 0) {
                echo '<div style="left: 0px; display: none;" class="level0-wrapper dropdown-6col">
                ...
                if($parent_id == 0){
                echo '<li class="level0 nav-5 level-top first" style="background-color: #ff5e5e;color: #fff;">';
                echo '<a>
                <div style="margin-left:5px;margin-top:-5px;position:relative;display:inline-block;background-image:url(\'/img/mom_and_baby.png\');width:40px;height:40px;background-size:100% 100%;"></div>
                ';


                echo '<span style="color: #fff;position:relative;display:inline-block;top:-5px;">' . $arr[$parent_id][$i]->name . '</span>
                </a>';
                }


                if($parent_id !== 0) {
                echo '<li style="" class="level1 nav-6-1 first parent item"> 
                <a href="grid.html"> 
                <span class="sub_menu_link" style="color:darkblue">>' . $arr[$parent_id][$i]->name . '</span> 
                </a>
                 ';
                ...
                <li class="level0 nav-5 level-top first">
                    <a class="level-top">
                        <div style="margin-left:5px;margin-top:-5px;position:relative;display:inline-block;background-image:url('/img/home-5-xxl.png');width:40px;height:40px;background-size:100% 100%;"></div>

                        <span style="color: #fff;position:relative;display:inline-block;top:-5px;">Недвижимость</span> <span class="category-label-hot">горячая</span></a>
        ...
        <div class="nav-inner blocker" style="position:relative;">

            <ul id="nav_1" class="hidden-xs">
                <li id="nav-home_1" class="level0 parent drop-menu active"><a href="index.html"><span>Home</span> </a>
                    <ul class="level1" style="display: none;">
                        <li class="level1 first parent"><a href="../../layout-1/green/index.html"><span> Home Version 1</span></a> </li>
                        <li class="level1 parent"><a href="../../layout-2/green/index.html"><span> Home Version 2</span></a> </li>
                        <li class="level1 parent"><a href="../../layout-2/aqua/index.html"><span>Aqua</span></a> </li>
