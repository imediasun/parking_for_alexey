                                                ...
                                                <div class="tab-pane m-t-10 fade" id="tab1">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="hidden" name="id_tradecentre" value="<?php echo $tradecentre->id ?>">
                                                                <input type="hidden" name="user_id" value="<?php echo $user->id ?>">
                                                                <input class="form-control" name="name" placeholder="Enter the name of TC..." type="text"
                                                                       value="<?php echo $tradecentre->name ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input id="example-email" name="email" class="form-control" value="<?php echo $user->email ?>"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="logo_preview">
                                                                ...
                                                                <img style="position:absolute;width:150px;" src="/photos/<?php echo $tradecentre->image_small ?>">
                                                        ...
                                                        <div class="form-group clearfix">
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <textarea class="form-control" name="note" rows="5"><?php echo $tradecentre->description ?></textarea>
                                                                    </div>
                                                                </div>
